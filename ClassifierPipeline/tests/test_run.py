...
def test_queue_pre_ingest_input_text_uses_config_default_prefix(monkeypatch, dummy_logger):
    ...
    assert captured[0][0]["output_path"] == "/prepared/configured-prefix_123_classified.tsv"
...
def test_queue_pre_ingest_input_text_uses_override_prefix(monkeypatch, dummy_logger):
    ...
    assert captured[0][0]["output_path"] == "/prepared/custom-prefix_123_classified.tsv"
    assert captured[0][0]["run_id"] == 123
